...
[![DOCS](https://img.shields.io/badge/Documentation-see%20docs-green?style=flat-square&logo=appveyor)](https://github.com/shiyasmohd/shieldx/blob/main/README.md) 
[![UI ](https://img.shields.io/badge/User%20Interface-Link%20to%20UI-orange?style=flat-square&logo=appveyor)](https://shiyasmohd.github.io/shieldX/)

ShieldX is a blockchain-based evidence management system to prevent manipulation in Indian courts.
...
1. Open [ShieldX](https://shiyasmohd.github.io/shieldX/) in your browser.
...
4. Connect ShieldX website to Metamask.

5. Go ahead and explore ShieldX.
...
```
https://github.com/shiyasmohd/shieldx.git
```

2. Go to the cloned directory (e.g. `cd shieldx`).
...
9. Go ahead and explore ShieldX.
